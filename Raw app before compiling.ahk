...
Gui, 1:Add, Button, x12 y278 w134 h26 , Readme
Filetype1 := "exe"
Filetype2 := "lnk"
MenuStart:
...
generate:
    {
        ...
        MsgBox, The user selected the following game:`n %Logfile% 
        ...
        Next:
        if (Gameextenstion!=Filetype1|Gameextenstion!=Filetype2)
        {
            MsgBox You have uploaded the wrong file type. Potentially a Steam Shortcut. Try again. 
            Goto, Menustart
        }
        Nextup:
            ...
            MsgBox, %Gamenameonly% app built with VPN Pause Service has been sent to Desktop. `nYou must launch from Desktop that shortcut. Move anywhere.
